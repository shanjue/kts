          ...
          <div class="box box-danger alert alert-success">
            ...
            <div class="box-body">
              ...
              <form role="form" method="post">
                ...
                <a href="{{url('/yourgallery/'.Auth::user()->id)}}" class="btn btn-primary" ><i class="fas fa-upload"></i> Upload New <i class="fas fa-image"></i> photo</a> 
            ...
            <div class="checkbox" style="margin:0 5px;">
              ...
              <button type="submit" class="btn btn-success upload-result"><i class="fas fa-edit" style="font-size:1em;"></i> Edit Now</button>
